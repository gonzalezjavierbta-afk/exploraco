...
//
// Uso:
//   DATABASE_URL=postgres://... node api/seed-parque-la-florida.js --dry
//   DATABASE_URL=postgres://... node api/seed-parque-la-florida.js
//
...
(async function main() {
  ...
  if (!url) {
    ...
    console.error('Uso: DATABASE_URL=postgres://... node api/seed-parque-la-florida.js [--dry]');
    process.exit(1);
  }
