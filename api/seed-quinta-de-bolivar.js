...
//
// Uso:
//   DATABASE_URL=postgres://... node api/seed-quinta-de-bolivar.js --dry
//   DATABASE_URL=postgres://... node api/seed-quinta-de-bolivar.js
//
...
(async function main() {
  ...
  if (!url) {
    ...
    console.error('Uso: DATABASE_URL=postgres://... node api/seed-quinta-de-bolivar.js [--dry]');
    process.exit(1);
  }
