...
//
// Uso:
//   DATABASE_URL=postgres://... node api/seed-theatron.js --dry
//   DATABASE_URL=postgres://... node api/seed-theatron.js
//
...
(async function main() {
  ...
  if (!url) {
    ...
    console.error('Uso: DATABASE_URL=postgres://... node api/seed-theatron.js [--dry]');
    process.exit(1);
  }
