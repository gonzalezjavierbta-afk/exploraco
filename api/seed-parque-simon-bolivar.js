// api/seed-parque-simon-bolivar.js
...
// sitio, _buildTagsObj/_placeToAPI). Patron de api/seed-museo-del-oro.js.
//
...
//
// Uso:
//   DATABASE_URL=postgres://... node api/seed-parque-simon-bolivar.js --dry
//   DATABASE_URL=postgres://... node api/seed-parque-simon-bolivar.js
//
...
(async function main() {
  ...
  if (!url) {
    ...
    console.error('Uso: DATABASE_URL=postgres://... node api/seed-parque-simon-bolivar.js [--dry]');
    process.exit(1);
  }
