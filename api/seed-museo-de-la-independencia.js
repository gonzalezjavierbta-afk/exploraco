// api/seed-museo-de-la-independencia.js
...
// guardaria el formulario admin.html. Patron de api/seed-museo-del-oro.js con
// upsert completo.
//
...
//
// Uso:
//   DATABASE_URL=postgres://... node api/seed-museo-de-la-independencia.js --dry
//   DATABASE_URL=postgres://... node api/seed-museo-de-la-independencia.js
//
...
(async function main() {
  ...
  if (!url) {
    ...
    console.error('Uso: DATABASE_URL=postgres://... node api/seed-museo-de-la-independencia.js [--dry]');
    process.exit(1);
  }
