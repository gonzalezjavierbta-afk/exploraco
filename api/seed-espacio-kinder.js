...
//
// Uso:
//   DATABASE_URL=postgres://... node api/seed-espacio-kinder.js --dry
//   DATABASE_URL=postgres://... node api/seed-espacio-kinder.js
//
...
(async function main() {
  ...
  if (!url) {
    ...
    console.error('Uso: DATABASE_URL=postgres://... node api/seed-espacio-kinder.js [--dry]');
    process.exit(1);
  }
