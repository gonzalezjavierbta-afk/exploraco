...
// admin.html. Patron de api/seed-museo-del-oro.js con upsert completo.
//
...
//
// Uso:
//   DATABASE_URL=postgres://... node api/seed-el-virrey.js --dry
//   DATABASE_URL=postgres://... node api/seed-el-virrey.js
//
...
(async function main() {
  ...
  if (!url) {
    ...
    console.error('Uso: DATABASE_URL=postgres://... node api/seed-el-virrey.js [--dry]');
    process.exit(1);
  }
