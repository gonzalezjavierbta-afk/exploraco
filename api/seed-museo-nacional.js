...
//
// Uso:
//   DATABASE_URL=postgres://... node api/seed-museo-nacional.js --dry
//   DATABASE_URL=postgres://... node api/seed-museo-nacional.js
//
...
(async function main() {
  ...
  if (!url) {
    ...
    console.error('Uso: DATABASE_URL=postgres://... node api/seed-museo-nacional.js [--dry]');
    process.exit(1);
  }
