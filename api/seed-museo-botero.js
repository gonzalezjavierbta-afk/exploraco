...
//
// Uso:
//   DATABASE_URL=postgres://... node api/seed-museo-botero.js --dry
//   DATABASE_URL=postgres://... node api/seed-museo-botero.js
//
...
(async function main() {
  ...
  if (!url) {
    ...
    console.error('Uso: DATABASE_URL=postgres://... node api/seed-museo-botero.js [--dry]');
    process.exit(1);
  }
