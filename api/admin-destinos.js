  ...
  try {
    ...
    if (method === 'GET') {
      ...
      return {
        statusCode: 200,
        headers,
        body: JSON.stringify({ ok: true, total: parseInt(total[0].n), data: rows }),
      };
    }
    ...
    if (method === 'POST') {
      ...
      const rows = await sql`
        INSERT INTO destinos (
          ...
          lat, lng, whatsapp, email, web, instagram, booking, precio_desde,
          emoji, hero_bg, rating, total_resenas, status, destacado
        ) VALUES (
          ${b.slug}, ${b.nombre}, ${b.categoria_slug},
          ${b.lead || ''}, ${b.desc || ''},
          ${b.city || ''}, ${b.region || ''},
          ${b.lat || null}, ${b.lng || null},
          ${b.whatsapp || ''}, ${b.email || ''}, ${b.web || ''},
          ${b.instagram || ''}, ${b.booking || ''}, ${b.price || ''},
          ${b.emoji || '📍'}, ${b.hero_bg || 'linear-gradient(135deg,#111,#222)'},
