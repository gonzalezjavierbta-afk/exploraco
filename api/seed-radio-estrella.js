...
//
// Uso:
//   DATABASE_URL=postgres://... node api/seed-radio-estrella.js --dry
//   DATABASE_URL=postgres://... node api/seed-radio-estrella.js
//
...
(async function main() {
  ...
  if (!url) {
    ...
    console.error('Uso: DATABASE_URL=postgres://... node api/seed-radio-estrella.js [--dry]');
    process.exit(1);
  }
