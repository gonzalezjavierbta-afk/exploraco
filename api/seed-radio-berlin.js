...
//
// Uso:
//   DATABASE_URL=postgres://... node api/seed-radio-berlin.js --dry
//   DATABASE_URL=postgres://... node api/seed-radio-berlin.js
//
...
(async function main() {
  ...
  if (!url) {
    ...
    console.error('Uso: DATABASE_URL=postgres://... node api/seed-radio-berlin.js [--dry]');
    process.exit(1);
  }
