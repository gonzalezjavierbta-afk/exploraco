// api/seed-monserrate-dificultad.js
...
//
// Uso:
//   DATABASE_URL=postgres://... node api/seed-monserrate-dificultad.js
//   DATABASE_URL=postgres://... node api/seed-monserrate-dificultad.js --dry
//
...
(async function main() {
  ...
  if (!url) {
    ...
    console.error('Uso: DATABASE_URL=postgres://... node api/seed-monserrate-dificultad.js [--dry]');
    process.exit(1);
  }
