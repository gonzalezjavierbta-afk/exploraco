...
//
// Uso:
//   DATABASE_URL=postgres://... node api/seed-gate-club.js --dry
//   DATABASE_URL=postgres://... node api/seed-gate-club.js
//
...
(async function main() {
  ...
  if (!url) {
    ...
    console.error('Uso: DATABASE_URL=postgres://... node api/seed-gate-club.js [--dry]');
    process.exit(1);
  }
