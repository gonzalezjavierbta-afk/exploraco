// api/seed-monserrate-entradas.js
...
//
// Uso:
//   DATABASE_URL=postgres://... node api/seed-monserrate-entradas.js
//   DATABASE_URL=postgres://... node api/seed-monserrate-entradas.js --dry
//
...
(async function main() {
  ...
  if (!url) {
    ...
    console.error('Uso: DATABASE_URL=postgres://... node api/seed-monserrate-entradas.js [--dry]');
    process.exit(1);
  }
