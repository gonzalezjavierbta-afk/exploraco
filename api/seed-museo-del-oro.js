...
// _placeToAPI). Patron de api/seed-bogota.js con upsert completo.
//
...
//
// Uso:
//   DATABASE_URL=postgres://... node api/seed-museo-del-oro.js --dry
//   DATABASE_URL=postgres://... node api/seed-museo-del-oro.js
//
...
(async function main() {
  ...
  if (!url) {
    ...
    console.error('Uso: DATABASE_URL=postgres://... node api/seed-museo-del-oro.js [--dry]');
    process.exit(1);
  }
