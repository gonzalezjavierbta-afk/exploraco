...
//
// Uso:
//   DATABASE_URL=postgres://... node api/seed-mad-radio.js --dry
//   DATABASE_URL=postgres://... node api/seed-mad-radio.js
//
...
(async function main() {
  ...
  if (!url) {
    ...
    console.error('Uso: DATABASE_URL=postgres://... node api/seed-mad-radio.js [--dry]');
    process.exit(1);
  }
