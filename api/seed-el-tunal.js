...
//
// Uso:
//   DATABASE_URL=postgres://... node api/seed-el-tunal.js --dry
//   DATABASE_URL=postgres://... node api/seed-el-tunal.js
//
...
(async function main() {
  ...
  if (!url) {
    ...
    console.error('Uso: DATABASE_URL=postgres://... node api/seed-el-tunal.js [--dry]');
    process.exit(1);
  }
