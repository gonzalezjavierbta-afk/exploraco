...
// _buildTagsObj/_placeToAPI). Patron de api/seed-bogota.js con upsert completo.
//
...
//
// Uso:
//   DATABASE_URL=postgres://... node api/seed-jardin-botanico.js --dry
//   DATABASE_URL=postgres://... node api/seed-jardin-botanico.js
//
...
(async function main() {
  ...
  if (!url) {
    ...
    console.error('Uso: DATABASE_URL=postgres://... node api/seed-jardin-botanico.js [--dry]');
    process.exit(1);
  }
