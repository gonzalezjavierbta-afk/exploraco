...
<title>${e(d.nombre)} en ${e(d.ciudad||'Colombia')} – ExploraCO</title>
<meta name="description" content="${e((d.lead||d.descripcion||'').slice(0,160))}">
<meta name="robots" content="index, follow">
<meta property="og:title" content="${e(d.nombre)} en ${e(d.ciudad||'Colombia')} – ExploraCO">
<meta property="og:description" content="${e((d.lead||'').slice(0,200))}">
<meta property="og:image" content="${e(hero)}">
<meta property="og:image:width" content="1200">
<meta property="og:image:height" content="630">
<meta property="og:type" content="place">
<meta property="og:url" content="https://exploraco.co/${e(d.slug)}.html">
<meta property="og:site_name" content="ExploraCO">
<meta name="twitter:card" content="summary_large_image">
<meta name="twitter:title" content="${e(d.nombre)} – ExploraCO">
<meta name="twitter:description" content="${e((d.lead||'').slice(0,200))}">
<meta name="twitter:image" content="${e(hero)}">
<meta name="theme-color" content="#E8A020">
<link rel="canonical" href="https://exploraco.co/${e(d.slug)}.html">
${buildSchemaLD(d, detalles, fotos, resenas, cat)}
<style>${css}</style>
</head>
<body>
