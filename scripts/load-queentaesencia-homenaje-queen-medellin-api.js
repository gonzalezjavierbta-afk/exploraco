// scripts/load-queentaesencia-homenaje-queen-medellin-api.js
// Carga la pagina dinamica queentaesencia-homenaje-queen-medellin.html a traves de la API de admin
// de produccion (/api/admin-destinos), enviando el MISMO payload que
// genera admin.html para la categoria evento.
//
// Uso:
//   node scripts/load-queentaesencia-homenaje-queen-medellin-api.js [URL] [TOKEN]

const { SLUG, HERO, PHOTOS, BASE, TAGS, FAQS } = require('./seed-queentaesencia-homenaje-queen-medellin.js');
