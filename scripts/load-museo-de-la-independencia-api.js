...
// Carga la pagina dinamica museo-de-la-independencia.html a traves de la API de
...
//
// Uso:
//   node scripts/load-museo-de-la-independencia-api.js [URL] [TOKEN]
...
const { SLUG, HERO, PHOTOS, BASE, TAGS, FAQS } = require('./seed-museo-de-la-independencia.js');
