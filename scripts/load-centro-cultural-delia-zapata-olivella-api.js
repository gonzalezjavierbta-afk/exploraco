...
// Carga la pagina dinamica centro-cultural-delia-zapata-olivella.html a
// traves de la API de admin de produccion (/api/admin-destinos), enviando el
// MISMO payload que genera admin.html (_placeToAPI/_buildTagsObj) para la
// categoria sitio.
//
// Uso:
//   node scripts/load-centro-cultural-delia-zapata-olivella-api.js [URL] [TOKEN]
...
const { SLUG, HERO, PHOTOS, BASE, TAGS, FAQS } = require('./seed-centro-cultural-delia-zapata-olivella.js');
