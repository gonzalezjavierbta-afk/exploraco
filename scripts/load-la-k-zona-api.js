// scripts/load-la-k-zona-api.js
// Carga la pagina dinamica la-k-zona.html a traves de la API de admin
...
//
// Uso:
//   node scripts/load-la-k-zona-api.js [URL] [TOKEN]
...
const { SLUG, HERO, PHOTOS, BASE, TAGS, FAQS } = require('./seed-la-k-zona.js');
