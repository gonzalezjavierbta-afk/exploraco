const seed = require('./seed-herbivoro-vegano-chapinero.js');
...
check('Seccion cocina y ambiente', html.includes('id="perfil-comida"') && html.includes('Cocina y ambiente') && html.includes('Artesanal Vegana') && html.includes('Urbana / Comfort Food'));
check('Seccion menu destacado', html.includes('id="menu"') && html.includes('Burger Monstruo de Seit') && html.includes('Queso de Almendras'));
check('Lunes cerrado en horarios', html.includes('id="horarios"') && html.includes('Cerrado'));
...
check('Hero con nombre', html.includes('Cocina Vegana'));
