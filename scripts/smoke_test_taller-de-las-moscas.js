// scripts/smoke_test_taller-de-las-moscas.js
...
const seed = require('./seed-taller-de-las-moscas.js');
...
const d = Object.assign({}, seed.BASE, { address: seed.BASE.direccion, fotos: [{ url: seed.HERO }], tags: seed.TAGS, rating: 0, total_resenas: 0, creado_en: new Date(), actualizado_en: new Date() });
...
check('Seccion checklist/equipamiento con primer item', !!eq0 && html.includes('id="checklist"') && inc(eq0.item));
...
check('Seccion regulaciones renderizada', html.includes('id="regulaciones"') && html.includes('Respetar las obras expuestas'));
...
check('Chip de direccion con Cra. 19a', html.includes('Cra. 19a'));
