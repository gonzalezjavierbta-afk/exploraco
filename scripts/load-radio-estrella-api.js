...
// Carga la pagina dinamica radio-estrella.html a traves de la API de admin
...
//
// Uso:
//   node scripts/load-radio-estrella-api.js [URL] [TOKEN]
...
const { SLUG, HERO, PHOTOS, BASE, TAGS, FAQS } = require('./seed-radio-estrella.js');
