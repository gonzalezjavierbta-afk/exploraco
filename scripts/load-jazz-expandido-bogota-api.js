// scripts/load-jazz-expandido-bogota-api.js
// Carga la pagina dinamica jazz-expandido-bogota.html a traves de la API de
// admin de produccion (/api/admin-destinos), enviando el MISMO payload que
// genera admin.html para la categoria evento.
//
// Uso:
//   node scripts/load-jazz-expandido-bogota-api.js [URL] [TOKEN]

const { SLUG, HERO, PHOTOS, BASE, TAGS, FAQS } = require('./seed-jazz-expandido-bogota.js');
