// scripts/load-republica-cabin-beds-bogota-api.js
// Carga la pagina dinamica republica-cabin-beds-bogota.html a traves de la API de admin
// de produccion (/api/admin-destinos), enviando el MISMO payload que
// genera admin.html para la categoria hostal.
//
// Uso:
//   node scripts/load-republica-cabin-beds-bogota-api.js [URL] [TOKEN]
//   URL por defecto: https://exploraco.vercel.app
//   TOKEN por defecto: exploraco12345 (ADMIN_SECRET de desarrollo)

const { SLUG, HERO, PHOTOS, BASE, TAGS, FAQS } = require('./seed-republica-cabin-beds-bogota.js');
...
const BOOKING_URL = "https://www.booking.com/hotel/co/republica-hostel-cabin-beds.html";
const HW_URL      = "https://www.hostelworld.com/p/322842/republica-bogota-cabin-beds/";
