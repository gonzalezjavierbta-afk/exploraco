// scripts/load-salto-del-tequendama-api.js
// Carga la pagina dinamica salto-del-tequendama.html a traves de la API de
...
//
// Uso:
//   node scripts/load-salto-del-tequendama-api.js [URL] [TOKEN]
...
const { SLUG, HERO, PHOTOS, BASE, TAGS, FAQS } = require('./seed-salto-del-tequendama.js');
