...
// Carga la pagina dinamica espacio-kinder.html a traves de la API de admin
...
//
// Uso:
//   node scripts/load-espacio-kinder-api.js [URL] [TOKEN]
...
const { SLUG, HERO, PHOTOS, BASE, TAGS, FAQS } = require('./seed-espacio-kinder.js');
