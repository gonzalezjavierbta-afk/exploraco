...
// _buildTagsObj/_placeToAPI). Patron de scripts/seed-monserrate-*.js pero con
...
//
// Uso:
//   DATABASE_URL=postgres://... node scripts/seed-lacandelaria.js
//   DATABASE_URL=postgres://... node scripts/seed-lacandelaria.js --dry
//
...
(async function main() {
  ...
  if (!url) {
    ...
    console.error('Uso: DATABASE_URL=postgres://... node scripts/seed-lacandelaria.js [--dry]');
    process.exit(1);
  }
