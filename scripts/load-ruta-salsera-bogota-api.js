// scripts/load-ruta-salsera-bogota-api.js
// Carga el post de blog "Ruta Salsera de Bogota" a traves de la API de admin
// de produccion (/api/admin-destinos), categoria blog.
//
// Uso:
//   node scripts/load-ruta-salsera-bogota-api.js [URL] [TOKEN]
//   URL por defecto: https://exploraco.vercel.app
//   TOKEN por defecto: exploraco12345 (ADMIN_SECRET de desarrollo)

const { SLUG, HERO, PHOTOS, BASE, TAGS, FAQS, FOTOS_GALERIA } = require('./seed-ruta-salsera-bogota.js');
