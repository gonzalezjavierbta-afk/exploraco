// scripts/load-ulibro-bucaramanga-api.js
// Carga la pagina dinamica ulibro-bucaramanga.html a traves de la API de
// admin de produccion (/api/admin-destinos), enviando el MISMO payload que
// genera admin.html para la categoria evento.
//
// Uso:
//   node scripts/load-ulibro-bucaramanga-api.js [URL] [TOKEN]
//   URL por defecto: https://exploraco.vercel.app
//   TOKEN por defecto: exploraco12345 (ADMIN_SECRET de desarrollo)

const { SLUG, HERO, PHOTOS, BASE, TAGS, FAQS } = require('./seed-ulibro-bucaramanga.js');
