...
// Carga la pagina dinamica el-tunal.html a traves de la API de admin de
...
//
// Uso:
//   node scripts/load-el-tunal-api.js [URL] [TOKEN]
...
const { SLUG, HERO, PHOTOS, BASE, TAGS, FAQS } = require('./seed-el-tunal.js');
