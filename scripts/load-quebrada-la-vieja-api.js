// scripts/load-quebrada-la-vieja-api.js
// Carga la pagina dinamica quebrada-la-vieja.html a traves de la API de admin
...
//
// Uso:
//   node scripts/load-quebrada-la-vieja-api.js [URL] [TOKEN]
...
const { SLUG, HERO, PHOTOS, BASE, TAGS, FAQS } = require('./seed-quebrada-la-vieja.js');
