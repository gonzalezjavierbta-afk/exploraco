const seed = require('./seed-caballete-y-rezo-usaquen.js');
...
check('Seccion cocina y ambiente', html.includes('id="perfil-comida"') && html.includes('Cocina y ambiente') && html.includes('Cerveza Artesanal') && html.includes('Norteamericana'));
check('Seccion menu destacado', html.includes('id="menu"') && html.includes('Hamburguesa La Santanera') && html.includes('Papas Caseras Trufadas'));
...
check('Hero con nombre', html.includes('Burger Bar'));
