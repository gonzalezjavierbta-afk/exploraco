...
// Carga la pagina dinamica museo-del-oro.html a traves de la API de admin
...
//
// Uso:
//   node scripts/load-museo-del-oro-api.js [URL] [TOKEN]
...
const { SLUG, HERO, PHOTOS, BASE, TAGS, FAQS } = require('./seed-museo-del-oro.js');
