// scripts/load-lacandelaria-api.js
// Carga la pagina dinamica lacandelaria.html a traves de la API de admin
...
//
// Uso:
//   node scripts/load-lacandelaria-api.js [URL] [TOKEN]
//   URL por defecto: https://exploraco.vercel.app
//   TOKEN por defecto: exploraco12345 (ADMIN_SECRET de desarrollo)
//
// Idempotente en la practica: POST crea con status publicado; PUT
// actualiza campos y hace MERGE de tags si la fila ya existe.

const { SLUG, HERO, PHOTOS, BASE, TAGS, FAQS } = require('./seed-lacandelaria.js');
