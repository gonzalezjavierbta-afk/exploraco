// scripts/load-parranda-vallenata-barranquilla-api.js
// Carga la pagina dinamica parranda-vallenata-barranquilla.html a traves de la API de admin
// de produccion (/api/admin-destinos), enviando el MISMO payload que
// genera admin.html para la categoria evento.
//
// Uso:
//   node scripts/load-parranda-vallenata-barranquilla-api.js [URL] [TOKEN]

const { SLUG, HERO, PHOTOS, BASE, TAGS, FAQS } = require('./seed-parranda-vallenata-barranquilla.js');
