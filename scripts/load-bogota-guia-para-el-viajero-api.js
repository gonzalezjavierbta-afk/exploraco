// scripts/load-bogota-guia-para-el-viajero-api.js
// Carga el post de blog bogota-guia-para-el-viajero.html a traves de la
...
const { SLUG, HERO, PHOTOS, BASE, TAGS, FAQS, FOTOS_GALERIA } = require('./seed-bogota-guia-para-el-viajero.js');
