// scripts/load-quinoa-y-amaranto-la-candelaria-api.js
// Carga la pagina dinamica quinoa-y-amaranto-la-candelaria.html a traves de la
// API de admin de produccion (/api/admin-destinos), enviando el MISMO payload
// que genera admin.html para la categoria comida.
//
// Uso:
//   node scripts/load-quinoa-y-amaranto-la-candelaria-api.js [URL] [TOKEN]
//   URL por defecto: https://exploraco.vercel.app
//   TOKEN por defecto: exploraco12345 (ADMIN_SECRET de desarrollo)

const { SLUG, HERO, PHOTOS, BASE, TAGS, FAQS } = require('./seed-quinoa-y-amaranto-la-candelaria.js');
