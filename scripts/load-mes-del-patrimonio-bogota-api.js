// scripts/load-mes-del-patrimonio-bogota-api.js
// Carga la pagina dinamica mes-del-patrimonio-bogota.html a traves de la API
// de admin de produccion (/api/admin-destinos), enviando el MISMO payload que
// genera admin.html para la categoria evento.
//
// Uso:
//   node scripts/load-mes-del-patrimonio-bogota-api.js [URL] [TOKEN]

const { SLUG, HERO, PHOTOS, BASE, TAGS, FAQS } = require('./seed-mes-del-patrimonio-bogota.js');
