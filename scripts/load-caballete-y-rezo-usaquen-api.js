// scripts/load-caballete-y-rezo-usaquen-api.js
// Carga la pagina dinamica caballete-y-rezo-usaquen.html a traves de la API
// de admin de produccion (/api/admin-destinos), enviando el MISMO payload que
// genera admin.html para la categoria comida.
//
// Uso:
//   node scripts/load-caballete-y-rezo-usaquen-api.js [URL] [TOKEN]
//   URL por defecto: https://exploraco.vercel.app
//   TOKEN por defecto: exploraco12345 (ADMIN_SECRET de desarrollo)

const { SLUG, HERO, PHOTOS, BASE, TAGS, FAQS } = require('./seed-caballete-y-rezo-usaquen.js');
