// scripts/load-john-summit-chamorro-bogota-api.js
// Carga la pagina dinamica john-summit-chamorro-bogota.html a traves de la API de admin
// de produccion (/api/admin-destinos), enviando el MISMO payload que
// genera admin.html para la categoria evento.
//
// Uso:
//   node scripts/load-john-summit-chamorro-bogota-api.js [URL] [TOKEN]

const { SLUG, HERO, PHOTOS, BASE, TAGS, FAQS } = require('./seed-john-summit-chamorro-bogota.js');
