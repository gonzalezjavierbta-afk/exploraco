...
//
// Uso:
//   DATABASE_URL=postgres://... node scripts/seed-club-octava.js --dry
//   DATABASE_URL=postgres://... node scripts/seed-club-octava.js
//
...
(async function main() {
  ...
  if (!url) {
    ...
    console.error('Uso: DATABASE_URL=postgres://... node scripts/seed-club-octava.js [--dry]');
    process.exit(1);
  }
