const seed = require('./seed-dia-del-arte-urbano-bogota.js');
...
check('Fecha y sede con fecha formateada', html.includes('id="evento-fechas"') && html.includes('31 de Agosto de 2026'));
check('Edicion y sede en tarjetas', html.includes('Edicion 2026') && inc('Multiples puntos'));
check('Lineup con muralismo', html.includes('id="lineup"') && html.includes('Muralismo en vivo') && html.includes('video mapping'));
check('Agenda con intervenciones', html.includes('intervenciones de muralismo') && html.includes('Ciclovia'));
...
check('Mapa con coordenadas', html.includes('4.6409'));
