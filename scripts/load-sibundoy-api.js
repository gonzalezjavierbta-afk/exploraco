// scripts/load-sibundoy-api.js
// Carga la pagina dinamica sibundoy.html a traves de la API de
...
//
// Uso:
//   node scripts/load-sibundoy-api.js [URL] [TOKEN]
...
const { SLUG, HERO, PHOTOS, BASE, TAGS, FAQS } = require('./seed-sibundoy.js');
