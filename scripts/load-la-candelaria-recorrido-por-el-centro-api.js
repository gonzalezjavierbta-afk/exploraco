...
// Carga el post de blog la-candelaria-recorrido-por-el-centro.html a traves
// de la API de admin de produccion (/api/admin-destinos), enviando el MISMO
...
const { SLUG, HERO, PHOTOS, BASE, TAGS, FAQS, FOTOS_GALERIA } = require('./seed-la-candelaria-recorrido-por-el-centro.js');
