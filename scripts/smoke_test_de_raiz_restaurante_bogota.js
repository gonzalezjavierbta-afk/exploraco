const seed = require('./seed-de-raiz-restaurante-bogota.js');
...
check('Seccion cocina y ambiente', html.includes('id="perfil-comida"') && html.includes('Cocina y ambiente') && html.includes('Vegana / Saludable Gourmet'));
check('Seccion menu destacado', html.includes('id="menu"') && html.includes('Hamburguesa de Girasol y Setas') && html.includes('Cheesecake de Cashews y Frutos Rojos'));
check('Horarios por dia', html.includes('id="horarios"') && html.includes('08:00 - 22:00'));
...
check('Hero con nombre', html.includes('Cocina a Base de Plantas'));
check('Domicilio y plataformas', html.includes('Rappi') && html.includes('Directo WhatsApp'));
