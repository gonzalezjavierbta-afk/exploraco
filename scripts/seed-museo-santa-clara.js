// scripts/seed-museo-santa-clara.js
...
//
// Uso:
//   DATABASE_URL=postgres://... node scripts/seed-museo-santa-clara.js --dry
//   DATABASE_URL=postgres://... node scripts/seed-museo-santa-clara.js
//
...
(async function main() {
  ...
  if (!url) {
    ...
    console.error('Uso: DATABASE_URL=postgres://... node scripts/seed-museo-santa-clara.js [--dry]');
    process.exit(1);
  }
