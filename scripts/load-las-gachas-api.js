// scripts/load-las-gachas-api.js
// Carga la pagina dinamica las-gachas.html a traves de la API de
...
//
// Uso:
//   node scripts/load-las-gachas-api.js [URL] [TOKEN]
...
const { SLUG, HERO, PHOTOS, BASE, TAGS, FAQS } = require('./seed-las-gachas.js');
