...
// Carga la pagina dinamica mad-radio.html a traves de la API de admin
...
//
// Uso:
//   node scripts/load-mad-radio-api.js [URL] [TOKEN]
...
const { SLUG, HERO, PHOTOS, BASE, TAGS, FAQS } = require('./seed-mad-radio.js');
