...
// Carga la pagina dinamica museo-santa-clara.html a traves de la API de admin
...
//
// Uso:
//   node scripts/load-museo-santa-clara-api.js [URL] [TOKEN]
...
const { SLUG, HERO, PHOTOS, BASE, TAGS, FAQS } = require('./seed-museo-santa-clara.js');
