// scripts/load-cranky-croc-hostel-bogota-api.js
// Carga la pagina dinamica cranky-croc-hostel-bogota.html a traves de la API de admin
// de produccion (/api/admin-destinos), enviando el MISMO payload que
// genera admin.html para la categoria hostal.
//
// Uso:
//   node scripts/load-cranky-croc-hostel-bogota-api.js [URL] [TOKEN]
//   URL por defecto: https://exploraco.vercel.app
//   TOKEN por defecto: exploraco12345 (ADMIN_SECRET de desarrollo)

const { SLUG, HERO, PHOTOS, BASE, TAGS, FAQS } = require('./seed-cranky-croc-hostel-bogota.js');
...
const BOOKING_URL = "https://www.booking.com/hotel/co/the-cranky-croc-hostel.html";
const HW_URL      = "https://www.hostelworld.com/p/26229/the-cranky-croc-hostel/";
