const seed = require('./seed-hearth-summit-bogota.js');
...
check('Fecha y sede con fechas formateadas', html.includes('id="evento-fechas"') && html.includes('31 de Agosto de 2026') && html.includes('2 de Septiembre de 2026'));
check('Edicion y sede en tarjetas', html.includes('Edicion 2026') && inc('Centro Felicidad Chapinero'));
check('Lineup con keynotes y talleres', html.includes('id="lineup"') && html.includes('Keynotes') && html.includes('biodanza'));
check('Agenda con bienvenida muisca', html.includes('inauguracion oficial') || html.includes('MUISCA') || html.includes('bienvenida artistica'));
...
check('Mapa con coordenadas', html.includes('4.6431'));
