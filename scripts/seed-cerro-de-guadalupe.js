// scripts/seed-cerro-de-guadalupe.js
...
//
// Uso:
//   DATABASE_URL=postgres://... node scripts/seed-cerro-de-guadalupe.js --dry
//   DATABASE_URL=postgres://... node scripts/seed-cerro-de-guadalupe.js
//
...
(async function main() {
  ...
  if (!url) {
    ...
    console.error('Uso: DATABASE_URL=postgres://... node scripts/seed-cerro-de-guadalupe.js [--dry]');
    process.exit(1);
  }
