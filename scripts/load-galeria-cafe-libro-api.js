// scripts/load-galeria-cafe-libro-api.js
// Carga la pagina dinamica galeria-cafe-libro.html a traves de la API de admin
// de produccion (/api/admin-destinos), enviando el MISMO payload que
// genera admin.html para la categoria sitio.
//
// Uso:
//   node scripts/load-galeria-cafe-libro-api.js [URL] [TOKEN]
//   URL por defecto: https://exploraco.vercel.app
//   TOKEN por defecto: exploraco12345 (ADMIN_SECRET de desarrollo)

const { SLUG, HERO, PHOTOS, BASE, TAGS, FAQS } = require('./seed-galeria-cafe-libro.js');
