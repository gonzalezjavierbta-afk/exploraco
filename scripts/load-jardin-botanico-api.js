// scripts/load-jardin-botanico-api.js
// Carga la pagina dinamica jardin-botanico-bogota.html a traves de la API de
...
//
// Uso:
//   node scripts/load-jardin-botanico-api.js [URL] [TOKEN]
...
const { SLUG, HERO, PHOTOS, BASE, TAGS, FAQS } = require('./seed-jardin-botanico.js');
