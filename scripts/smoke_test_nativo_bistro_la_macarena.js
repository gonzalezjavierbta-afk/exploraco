const seed = require('./seed-nativo-bistro-la-macarena.js');
...
check('Seccion cocina y ambiente', html.includes('id="perfil-comida"') && html.includes('Cocina y ambiente') && html.includes('Autora Vegana') && html.includes('Latinoamericana'));
check('Seccion menu destacado', html.includes('id="menu"') && html.includes('Ceviche de Orellanas') && html.includes('Encocado del Pac'));
check('Lunes y Martes cerrados en horarios', html.includes('id="horarios"') && html.includes('Cerrado'));
check('Seccion opciones y domicilio', html.includes('id="delivery"') && html.includes('Opciones dieteticas y domicilio') && html.includes('Sin Gluten'));
check('Hero con nombre', html.includes('Nativo Bistro Plant-Based'));
