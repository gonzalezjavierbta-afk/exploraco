...
// Carga la pagina dinamica gate-club.html a traves de la API de admin
...
//
// Uso:
//   node scripts/load-gate-club-api.js [URL] [TOKEN]
...
const { SLUG, HERO, PHOTOS, BASE, TAGS, FAQS } = require('./seed-gate-club.js');
