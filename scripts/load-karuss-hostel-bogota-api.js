// scripts/load-karuss-hostel-bogota-api.js
// Carga la pagina dinamica karuss-hostel-bogota.html a traves de la API de admin
// de produccion (/api/admin-destinos), enviando el MISMO payload que
// genera admin.html para la categoria hostal.
//
// Uso:
//   node scripts/load-karuss-hostel-bogota-api.js [URL] [TOKEN]
//   URL por defecto: https://exploraco.vercel.app
//   TOKEN por defecto: exploraco12345 (ADMIN_SECRET de desarrollo)

const { SLUG, HERO, PHOTOS, BASE, TAGS, FAQS } = require('./seed-karuss-hostel-bogota.js');
...
const BOOKING_URL = "";
const HW_URL      = "https://www.hostelworld.com/p/69727/karuss-hostel/";
