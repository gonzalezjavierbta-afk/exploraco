// scripts/load-ferias-y-fiestas-guaduas-2026-api.js
// Carga la pagina dinamica ferias-y-fiestas-guaduas-2026.html a traves de la API de admin
// de produccion (/api/admin-destinos), enviando el MISMO payload que
// genera admin.html para la categoria evento.
//
// Uso:
//   node scripts/load-ferias-y-fiestas-guaduas-2026-api.js [URL] [TOKEN]

const { SLUG, HERO, PHOTOS, BASE, TAGS, FAQS } = require('./seed-ferias-y-fiestas-guaduas-2026.js');
