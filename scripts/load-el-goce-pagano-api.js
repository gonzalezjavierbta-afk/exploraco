// scripts/load-el-goce-pagano-api.js
// Carga la pagina dinamica el-goce-pagano.html a traves de la API de admin
// de produccion (/api/admin-destinos), enviando el MISMO payload que
// genera admin.html para la categoria sitio.
//
// Uso:
//   node scripts/load-el-goce-pagano-api.js [URL] [TOKEN]
//   URL por defecto: https://exploraco.vercel.app
//   TOKEN por defecto: exploraco12345 (ADMIN_SECRET de desarrollo)

const { SLUG, HERO, PHOTOS, BASE, TAGS, FAQS } = require('./seed-el-goce-pagano.js');
