// scripts/load-masaya-hostel-bogota-api.js
// Carga la pagina dinamica masaya-hostel-bogota.html a traves de la API de admin
// de produccion (/api/admin-destinos), enviando el MISMO payload que
// genera admin.html para la categoria hostal.
//
// Uso:
//   node scripts/load-masaya-hostel-bogota-api.js [URL] [TOKEN]
//   URL por defecto: https://exploraco.vercel.app
//   TOKEN por defecto: exploraco12345 (ADMIN_SECRET de desarrollo)

const { SLUG, HERO, PHOTOS, BASE, TAGS, FAQS } = require('./seed-masaya-hostel-bogota.js');
...
const BOOKING_URL = "";
const HW_URL      = "https://www.hostelworld.com/p/57813/masaya-bogota/";
