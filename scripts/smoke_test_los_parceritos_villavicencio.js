const seed = require('./seed-los-parceritos-villavicencio.js');
...
check('Edicion y sede en tarjetas', html.includes('Gira Los Parceritos 2026') && inc(seed.TAGS.sede));
check('Lineup con Lokillo y Jota P', html.includes('id="lineup"') && inc('Lokillo') && inc('Jota P') && (html.match(/Escenario principal/g) || []).length >= 2);
check('Agenda con puertas y show', html.includes('Apertura de puertas') && inc('Inicio del show de Los Parceritos'));
...
check('Mapa con coordenadas Villavicencio', html.includes('4.16'));
