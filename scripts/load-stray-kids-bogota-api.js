// scripts/load-stray-kids-bogota-api.js
// Carga la pagina dinamica stray-kids-bogota.html a traves de la API de admin
// de produccion (/api/admin-destinos), enviando el MISMO payload que
// genera admin.html para la categoria evento.
//
// Uso:
//   node scripts/load-stray-kids-bogota-api.js [URL] [TOKEN]

const { SLUG, HERO, PHOTOS, BASE, TAGS, FAQS } = require('./seed-stray-kids-bogota.js');
