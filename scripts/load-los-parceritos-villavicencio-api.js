// scripts/load-los-parceritos-villavicencio-api.js
// Carga la pagina dinamica los-parceritos-villavicencio.html a traves de la API de admin
// de produccion (/api/admin-destinos), enviando el MISMO payload que
// genera admin.html para la categoria evento.
//
// Uso:
//   node scripts/load-los-parceritos-villavicencio-api.js [URL] [TOKEN]

const { SLUG, HERO, PHOTOS, BASE, TAGS, FAQS } = require('./seed-los-parceritos-villavicencio.js');
