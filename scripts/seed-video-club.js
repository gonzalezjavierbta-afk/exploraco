...
//
// Uso:
//   DATABASE_URL=postgres://... node scripts/seed-video-club.js --dry
//   DATABASE_URL=postgres://... node scripts/seed-video-club.js
//
...
(async function main() {
  ...
  if (!url) {
    ...
    console.error('Uso: DATABASE_URL=postgres://... node scripts/seed-video-club.js [--dry]');
    process.exit(1);
  }
