...
// Carga la pagina dinamica museo-botero.html a traves de la API de admin
...
//
// Uso:
//   node scripts/load-museo-botero-api.js [URL] [TOKEN]
...
const { SLUG, HERO, PHOTOS, BASE, TAGS, FAQS } = require('./seed-museo-botero.js');
