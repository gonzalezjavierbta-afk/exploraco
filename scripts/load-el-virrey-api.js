...
// Carga la pagina dinamica el-virrey.html a traves de la API de admin de
...
//
// Uso:
//   node scripts/load-el-virrey-api.js [URL] [TOKEN]
...
const { SLUG, HERO, PHOTOS, BASE, TAGS, FAQS } = require('./seed-el-virrey.js');
