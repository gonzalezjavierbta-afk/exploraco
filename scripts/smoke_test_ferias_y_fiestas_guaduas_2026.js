const seed = require('./seed-ferias-y-fiestas-guaduas-2026.js');
...
check('Edicion y sede en tarjetas', html.includes('Ferias y Fiestas 2026') && inc(seed.TAGS.sede));
check('Lineup con artistas', html.includes('id="lineup"') && inc('Olga Valkiria') && inc('El Mono Zabaleta') && (html.match(/Escenario principal/g) || []).length >= 4);
check('Agenda con puertas y conciertos', html.includes('Apertura de puertas') && inc('El Mono Zabaleta en concierto'));
...
check('Mapa con coordenadas Guaduas', html.includes('5.0667'));
