// scripts/load-canon-del-guejar-api.js
// Carga la pagina dinamica canon-del-guejar.html a traves de la API de
...
//
// Uso:
//   node scripts/load-canon-del-guejar-api.js [URL] [TOKEN]
...
const { SLUG, HERO, PHOTOS, BASE, TAGS, FAQS } = require('./seed-canon-del-guejar.js');
