// scripts/smoke_test_salto-del-tequendama.js
...
var seed = require('./seed-salto-del-tequendama.js');
...
check('Seccion regulaciones con texto', html.includes('id="regulaciones"') && inc('Prohibido el paso de barreras'));

check('Dificultad y epoca ideal presentes', html.includes('id="dificultad"') && inc('\u00c9poca ideal para visitar'));
