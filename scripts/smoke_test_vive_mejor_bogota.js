const seed = require('./seed-vive-mejor-bogota.js');
...
check('Fecha y sede con fechas formateadas', html.includes('id="evento-fechas"') && html.includes('5 de Septiembre de 2026') && html.includes('6 de Septiembre de 2026'));
check('Edicion y sede en tarjetas', html.includes('Edicion 2026') && inc('Centro Felicidad Chapinero'));
check('Lineup con Dr. Restrepo', html.includes('id="lineup"') && html.includes('Oswaldo Restrepo') && html.includes('Zonas Azules'));
check('Agenda con economia plateada', html.includes('economia plateada') || html.includes('economia plateada'));
