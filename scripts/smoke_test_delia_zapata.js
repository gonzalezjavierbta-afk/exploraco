// scripts/smoke_test_delia_zapata.js
...
const seed = require('./seed-centro-cultural-delia-zapata-olivella.js');
...
check('Seccion regulaciones renderizada', html.includes('id="regulaciones"') && html.includes('Prohibido consumir alimentos en salas'));
