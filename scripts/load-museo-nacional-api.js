...
// Carga la pagina dinamica museo-nacional.html a traves de la API de admin
...
//
// Uso:
//   node scripts/load-museo-nacional-api.js [URL] [TOKEN]
...
const { SLUG, HERO, PHOTOS, BASE, TAGS, FAQS } = require('./seed-museo-nacional.js');
