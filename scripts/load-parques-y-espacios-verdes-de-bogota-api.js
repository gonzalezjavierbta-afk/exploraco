...
// Carga el post de blog parques-y-espacios-verdes-de-bogota.html a traves
...
const { SLUG, HERO, PHOTOS, BASE, TAGS, FAQS, FOTOS_GALERIA } = require('./seed-parques-y-espacios-verdes-de-bogota.js');
