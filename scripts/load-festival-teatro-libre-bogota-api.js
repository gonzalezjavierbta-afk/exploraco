// scripts/load-festival-teatro-libre-bogota-api.js
// Carga la pagina dinamica festival-teatro-libre-bogota.html a traves de la
// API de admin de produccion (/api/admin-destinos), enviando el MISMO
// payload que genera admin.html para la categoria evento.
//
// Uso:
//   node scripts/load-festival-teatro-libre-bogota-api.js [URL] [TOKEN]
//   URL por defecto: https://exploraco.vercel.app
//   TOKEN por defecto: exploraco12345 (ADMIN_SECRET de desarrollo)

const { SLUG, HERO, PHOTOS, BASE, TAGS, FAQS } = require('./seed-festival-teatro-libre-bogota.js');
