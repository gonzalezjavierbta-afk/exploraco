// scripts/seed-parque-nacional.js
...
//
// Uso:
//   DATABASE_URL=postgres://... node scripts/seed-parque-nacional.js --dry
//   DATABASE_URL=postgres://... node scripts/seed-parque-nacional.js
//
...
(async function main() {
  ...
  if (!url) {
    ...
    console.error('Uso: DATABASE_URL=postgres://... node scripts/seed-parque-nacional.js [--dry]');
    process.exit(1);
  }
