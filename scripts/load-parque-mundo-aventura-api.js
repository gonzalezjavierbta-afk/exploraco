// scripts/load-parque-mundo-aventura-api.js
// Carga la pagina dinamica parque-mundo-aventura.html a traves de la API de
...
//
// Uso:
//   node scripts/load-parque-mundo-aventura-api.js [URL] [TOKEN]
...
const { SLUG, HERO, PHOTOS, BASE, TAGS, FAQS } = require('./seed-parque-mundo-aventura.js');
