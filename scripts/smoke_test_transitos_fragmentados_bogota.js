const seed = require('./seed-transitos-fragmentados-bogota.js');
...
check('Fecha y sede con fecha formateada', html.includes('id="evento-fechas"') && html.includes('3 de Septiembre de 2026'));
check('Edicion y sede en tarjetas', html.includes('Exposici') && inc('CEFE Chapinero'));
check('Lineup con artistas y curaduria', html.includes('id="lineup"') && inc('Isabella Vargas') && inc('Mary Barrios') && inc('Curadur'));
check('Agenda con exposicion y taller', html.includes('Exposici') && inc('Foto en espacio p'));
...
check('Mapa con coordenadas del CEFE Chapinero', html.includes('4.6735'));
