// scripts/load-la-casa-del-oso-api.js
// Carga la pagina dinamica la-casa-del-oso.html a traves de la API de admin
...
//
// Uso:
//   node scripts/load-la-casa-del-oso-api.js [URL] [TOKEN]
...
const { SLUG, HERO, PHOTOS, BASE, TAGS, FAQS } = require('./seed-la-casa-del-oso.js');
