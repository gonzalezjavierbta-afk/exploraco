const seed = require('./seed-mes-del-patrimonio-bogota.js');
...
check('Fecha y sede con fecha formateada', html.includes('id="evento-fechas"') && html.includes('1 de Septiembre de 2026'));
check('Edicion y sede en tarjetas', html.includes('Mes del Patrimonio 2026') && inc('Plaza de Bol'));
check('Lineup con recorridos', html.includes('id="lineup"') && inc('Recorrido Las Cruces') && inc('Parque Arqueol'));
check('Agenda con foro y plaza', html.includes('Foro del Mes del Patrimonio') && inc('Plaza de Bol'));
...
check('Mapa con coordenadas de Plaza de Bolivar', html.includes('4.59806'));
