...
// _placeToAPI). Patron de scripts/seed-lacandelaria.js con upsert completo.
//
...
//
// Uso:
//   DATABASE_URL=postgres://... node scripts/seed-bogota.js --dry
//   DATABASE_URL=postgres://... node scripts/seed-bogota.js
//
...
(async function main() {
  ...
  if (!url) {
    ...
    console.error('Uso: DATABASE_URL=postgres://... node scripts/seed-bogota.js [--dry]');
    process.exit(1);
  }
