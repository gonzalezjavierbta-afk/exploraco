// scripts/load-semana-del-bienestar-bogota-api.js
// Carga la pagina dinamica semana-del-bienestar-bogota.html a traves de la
// API de admin de produccion (/api/admin-destinos), enviando el MISMO
// payload que genera admin.html para la categoria evento.
//
// Uso:
//   node scripts/load-semana-del-bienestar-bogota-api.js [URL] [TOKEN]
//   URL por defecto: https://exploraco.vercel.app
//   TOKEN por defecto: exploraco12345 (ADMIN_SECRET de desarrollo)

const { SLUG, HERO, PHOTOS, BASE, TAGS, FAQS } = require('./seed-semana-del-bienestar-bogota.js');
