...
// Carga la pagina dinamica parque-nacional.html a traves de la API de admin de
// produccion (/api/admin-destinos), enviando el MISMO payload que genera
// admin.html (_placeToAPI/_buildTagsObj) para la categoria sitio.
//
// Uso:
//   node scripts/load-parque-nacional-api.js [URL] [TOKEN]
...
const { SLUG, HERO, PHOTOS, BASE, TAGS, FAQS } = require('./seed-parque-nacional.js');
