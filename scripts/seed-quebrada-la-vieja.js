// scripts/seed-quebrada-la-vieja.js
...
//
// Uso:
//   DATABASE_URL=postgres://... node scripts/seed-quebrada-la-vieja.js --dry
//   DATABASE_URL=postgres://... node scripts/seed-quebrada-la-vieja.js
//
...
(async function main() {
  ...
  if (!url) {
    ...
    console.error('Uso: DATABASE_URL=postgres://... node scripts/seed-quebrada-la-vieja.js [--dry]');
    process.exit(1);
  }
