...
// Carga la pagina dinamica theatron.html a traves de la API de admin
...
//
// Uso:
//   node scripts/load-theatron-api.js [URL] [TOKEN]
...
const { SLUG, HERO, PHOTOS, BASE, TAGS, FAQS } = require('./seed-theatron.js');
