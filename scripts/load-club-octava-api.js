...
// Carga la pagina dinamica club-octava.html a traves de la API de admin
...
//
// Uso:
//   node scripts/load-club-octava-api.js [URL] [TOKEN]
...
const { SLUG, HERO, PHOTOS, BASE, TAGS, FAQS } = require('./seed-club-octava.js');
