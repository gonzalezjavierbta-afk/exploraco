...
// Carga la pagina dinamica video-club.html a traves de la API de admin
...
//
// Uso:
//   node scripts/load-video-club-api.js [URL] [TOKEN]
...
const { SLUG, HERO, PHOTOS, BASE, TAGS, FAQS } = require('./seed-video-club.js');
