const seed = require('./seed-libera-2026-bogota.js');
...
check('Fecha y sede con fechas formateadas', html.includes('id="evento-fechas"') && html.includes('31 de Agosto de 2026') && html.includes('6 de Septiembre de 2026'));
check('Edicion y sede en tarjetas', html.includes('Tercera edicion') && inc('Cerlalc'));
check('Lineup con invitada NASA', html.includes('id="lineup"') && html.includes('Pilar Archila') && html.includes('NASA'));
check('Agenda con charlas y proyecciones', html.includes('muestra editorial') || html.includes('Muestra editorial'));
...
check('Mapa con coordenadas', html.includes('4.6508'));
